...
import 'package:passenger_app/features/booking/data/repository/geocoding_repository_impl.dart';
import 'package:passenger_app/features/booking/data/repository/location_search_repository_impl.dart';
import 'package:passenger_app/features/booking/domain/repository/geocoding_repository.dart';
...
void initBooking(GetIt sl) {
  ...
  sl.registerFactory(
    () => BookingBloc(geocodingRepository: sl<GeocodingRepository>()),
  );
}
